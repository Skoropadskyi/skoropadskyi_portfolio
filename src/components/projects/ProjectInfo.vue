...
<template>
	<div class="block sm:flex gap-0 sm:gap-10 mt-14">
		...
		<div class="w-full sm:w-1/3 text-left">
			...
			<div class="mb-7">
				<p
					class="font-tomorrow-medium text-2xl text-secondary-dark dark:text-secondary-light mb-2"
				>
				...
				<ul class="leading-loose">
					<li
						...
						:key="info"
						class="font-tomorrow-regular text-ternary-dark dark:text-ternary-light"
					>
			...
			<div class="mb-7">
				<p
					class="font-tomorrow-medium text-2xl text-ternary-dark dark:text-ternary-light mb-2"
				>
					{{ projectInfo.objectivesHeading }}
				</p>
				<p
					class="font-tomorrow-regular text-primary-dark dark:text-ternary-light"
				>
		...
		<div class="w-full sm:w-2/3 text-left mt-10 sm:mt-0">
			<p
				class="font-tomorrow-medium text-primary-dark dark:text-primary-light text-2xl font-bold mb-7"
			>
			...
			<p
				...
				class="font-tomorrow-regular mb-5 text-lg text-ternary-dark dark:text-ternary-light"
			>
